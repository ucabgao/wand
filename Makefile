...
SRCS	= picoc.c table.c lex.c parse.c expression.c heap.c type.c \
	...
	cstdlib/unistd.c cstdlib/socket.c graph.c
OBJS	:= $(SRCS:%.c=%.o)
...
count:
	@echo "Core:"
	@cat picoc.h interpreter.h picoc.c table.c lex.c parse.c expression.c platform.c heap.c type.c variable.c include.c debug.c graph.c | grep -v '^[ 	]*/\*' | grep -v '^[ 	]*$$' | wc
	@echo ""
	@echo "Everything:"
	@cat $(SRCS) *.h */*.h | wc
